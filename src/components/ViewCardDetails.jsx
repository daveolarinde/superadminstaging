...
const ViewCardDetails = () => {
  ...
  if (loading)
    return (
      <div className="text-gray-500 p-6 animate-pulse">
        Loading card details...
      </div>
    );

  if (!card)
    return <div className="text-gray-600 p-6">Card not found.</div>;
  ...
  return (
    <div className="p-6 text-gray-800 min-h-screen bg-gray-50">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 max-w-3xl mx-auto shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-10">
          ...
          <Detail
            ...
            value={card.number}
            className="tracking-widest text-emerald-600"
          />
          ...
          <Detail
            ...
            value={card.billing_postal_code || "N/A"}
          />
        ...
        <div className="mt-10 flex justify-end">
          <button
            onClick={() => navigate(-1)}
            className="bg-gray-100 hover:bg-gray-200 text-gray-800 text-sm px-5 py-2 rounded-lg border border-gray-300 transition"
          >
            Close
          </button>
        </div>
