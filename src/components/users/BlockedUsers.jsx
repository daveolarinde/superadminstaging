...
export default function BlockedUsers() {
  ...
  // Fetch blocked users for the table
  useEffect(() => {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="relative w-full sm:w-1/3">
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-red-300 focus:border-red-400 outline-none"
          />
          <svg
